...
# learner
# ---------------------------------------------------
from agent.model import UvfaType
...
class LearnerRunner():
    ...
    def train(self):
        ...
        # If experience, Add to RemoteMemory
...
class Agent57():
    def __init__(self,
                 ...
                 input_sequence=4,
                 dense_units_num=512,
                 enable_dueling_network=True,  # dueling network
                 dueling_network_type=DuelingNetwork.AVERAGE,  # dueling network
    ...
    def _train(self, actor_num, learner_allocate, verbose):
        ...
        for _ in range(actor_num):
            # model weights for communication
            weights_q = mp.Queue()
